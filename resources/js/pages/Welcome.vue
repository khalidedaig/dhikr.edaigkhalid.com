...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-gray-50 p-6 text-gray-900 lg:justify-center lg:p-8 dark:bg-gray-900 dark:text-gray-100">
        <header class="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                ...
                <template v-else>
                    <Link
                        :href="route('login')"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-gray-900 hover:border-gray-200 dark:text-gray-100 dark:hover:border-gray-700"
                    >
                        Log in
                    </Link>
                    <Link
        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg border border-gray-200 bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-lg lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-gray-200 dark:before:border-gray-700"
                        >
                            <span class="relative bg-white py-1 dark:bg-gray-800">
                                <span
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                class="inline-block rounded-sm border border-gray-900 bg-gray-900 px-5 py-1.5 text-sm leading-normal text-white hover:border-gray-800 hover:bg-gray-800 dark:border-gray-100 dark:bg-gray-100 dark:text-gray-900 dark:hover:border-white dark:hover:bg-white"
                            >
                                Deploy now
                            </a>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-gray-100 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-gray-800"
                >
                    <svg
